  ...
  productContainer.innerHTML += `
    <div class="product-card">
        <div class="product-image">
            ...
            <button class="card-action-btn edit-btn" onclick="location.href = '/add-products/${
              data.id
        ...
        <div class="product-info">
            ...
            <span class="price">$${
              data.sellPrice
            }</span><span class="actual-price">$${data.acutalPrice}</span>
        </div>
    </div>
    `;
};
  ...
  fetch("/delete-product", {
    ...
    .then((data) => {
      if (data == "success") {
        ...
        showAlert("some errer occured while deleting the product. try Again");
      }
    });
};
